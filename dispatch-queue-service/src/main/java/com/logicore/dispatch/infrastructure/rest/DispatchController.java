...
public class DispatchController {
    ...
    @DeleteMapping("/trucks/{placa}")
    public ResponseEntity<String> eliminarCamion(@PathVariable String placa) {
        try {
            dispatchService.eliminarCamion(placa);
            return ResponseEntity.ok("Camión con placa " + placa + " removido de la cola (revertido).");
        } catch (Exception e) {
