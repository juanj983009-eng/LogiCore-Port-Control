...
public class YardController {
    ...
    public ResponseEntity<String> eliminarContenedor(@PathVariable String codigoId) {
        try {
            yardService.eliminarContenedor(codigoId);
            return ResponseEntity.ok("Contenedor " + codigoId + " retirado del patio (revertido).");
        } catch (Exception e) {
